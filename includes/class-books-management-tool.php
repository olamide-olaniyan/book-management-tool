...
class Books_Management_Tool {
	...
	public function __construct() {
		if ( defined( 'BOOKS_MANAGEMENT_TOOL' ) ) {
			$this->version = BOOKS_MANAGEMENT_TOOL;
		} else {
			$this->version = '1.0.0';
		}
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( __DIR__ ) . 'includes/class-books-management-tool-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( __DIR__ ) . 'includes/class-books-management-tool-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( __DIR__ ) . 'admin/class-books-management-tool-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( __DIR__ ) . 'public/class-books-management-tool-public.php';
	...
	private function define_public_hooks() {
		...
		$this->loader->add_filter( 'page_template', $plugin_public, 'bmt_custom_page_template' );

		add_shortcode( 'render-bmt-content', array( $plugin_public, 'render_bmt_content' ) );
	}
